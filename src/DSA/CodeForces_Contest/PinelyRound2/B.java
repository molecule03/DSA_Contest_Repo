package DSA.CodeForces_Contest.PinelyRound2;
...
//    public static int minOperationsToIdentity(int n, int[] permutation) {
//        int operations = 0;
//        boolean[] processed = new boolean[n]; // Track processed elements
//
//        for (int i = 0; i < n; i++) {
//            if (!processed[i]) {
//                int x = permutation[i];
//                while (x <= n && !processed[x - 1]) {
//                    processed[x - 1] = true;
//                    x = permutation[x - 1];
//                }
//                operations++;
