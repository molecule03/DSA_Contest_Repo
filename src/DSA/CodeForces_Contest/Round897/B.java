package CodeForces_Contest.Round897;
...
public class B {
    ...
    public static void main(String[] args) {
        ...
        for (int tt=0; tt<T; tt++) {
            ...
            while (left < right) {
                ...
                if (s.charAt(left) == s.charAt(right) && (s.charAt(left) == '0')) {
                    p++;
                } else if (s.charAt(left) == s.charAt(right) && (s.charAt(left) == '1')) {
                    q++;
                }
                left++;
                right--;
            ...
            for (int i = 1; i <= n; i++) {
                if (count <= i && (i - count) <= (p * 2 + q * 2) + max && !((i - count) % 2 == 1 && n % 2 == 0)) {
                    arr[i] = 1;
                }
            }
    ...
    static boolean isPalindrome(String s) {
        ...
        while (left < right) {if (s.charAt(left++) != s.charAt(right--)) {return false;}}return true;
    }
