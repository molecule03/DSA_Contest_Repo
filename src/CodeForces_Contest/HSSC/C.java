package CodeForces_Contest.HSSC;
...
//            int seen[] = new int[x/2+1];
    ...
    static List<Integer> printDivisorsInList(int n) {
        ...
        for (int i=1; i<=Math.sqrt(n); i++){if (n%i==0){ if (n/i == i) {list.add(i);} else {list.add(i); list.add(n/i);}}} Collections.sort(list);return list;
    }
