package CodeForces_Contest.Round889;
...
public class C1 {
    ...
    public static void main(String[] args) {
        ...
        for (int tt=0; tt<T; tt++) {
            ...
            //            for(int i=0; i<n; i++){
//                out.print(Arrays.toString(min.poll())+" ");
//            }
//            out.println(" ");
//            for(int i=0; i<n; i++){
//                out.print(Arrays.toString(max.poll())+" ");
//
//
//
            List<int[]> ans = new ArrayList<>();

            PriorityQueue<int[]> min = new PriorityQueue<>((a,b)->(a[0]==b[0]) ? b[1]-a[1] : a[0]-b[0]);
            PriorityQueue<int[]> max = new PriorityQueue<>((a,b)->(a[0]==b[0]) ? b[1]-a[1] : b[0]-a[0]);

            for(int i=0; i<n; i++){
                min.offer(new int[]{arr[i], i});
