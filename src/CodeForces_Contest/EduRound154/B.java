package CodeForces_Contest.EduRound154;
    ...
    public static void main(String[] args) {
        ...
        for (int tt=0; tt<T; tt++) {
            ...
            int n= a.length();
                ...
                boolean flag = areStringsEqual(a, b);
...
//        }
        for (int i = 0; i < a.length() - 1; i++) {
            if (a.charAt(i) == a.charAt(0) && b.charAt(i) == a.charAt(0) &&
                    a.charAt(i + 1) == b.charAt(i + 1) && a.charAt(i + 1) == a.charAt(a.length() - 1)) {
                return false;
            }
        }
